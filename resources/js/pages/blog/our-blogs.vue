        ...
        <div class="main-container">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-7 md:gap-10">
                ...
                <article data-ns-animate data-delay="0.3" class="group">
                    ...
                    >
                        <figure
                            class="md:min-h-[260px] md:max-h-[260px] max-w-full xl:max-w-[409px] overflow-hidden"
                        >
                            <img
                        ...
                        <div class="px-4 py-6 md:p-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-normal sm:text-heading-5 text-tagline-1 mb-2 line-clamp-2">
                                    <a
                                        href="./blog-details-page.html"
                                        aria-label="Read more about online banking and rewards"
                                    >
                        ...
                        <div class="px-4 py-6 md:p-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-normal sm:text-heading-5 text-tagline-1 mb-2">
                                    <a
                                        href="./blog-details-page.html"
                                        aria-label="Read more about efficient banking operations"
                                    >
                ...
                <article data-ns-animate data-delay="0.3" class="group">
                    ...
                    >
                        ...
                        >
                            <img
                                src="images/blogs/blog-10.png"
                                alt="Digital creativity concept illustration"
                                loading="lazy"
                                class="w-full h-full object-cover"
                            />
                        </figure>
                        <div class="px-4 py-6 md:p-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-normal sm:text-heading-5 text-tagline-1 mb-2">
                                    <a href="./blog-details-page.html" aria-label="Read more about digital creativity">
                ...
                <article data-ns-animate data-delay="0.4" class="group">
                    ...
                    >
                        ...
                        >
                            <img
                                src="images/blogs/blog-11.png"
                                alt="Brand storytelling concept illustration"
                                loading="lazy"
                                class="w-full h-full object-cover"
                            />
                        </figure>
                        <div class="px-4 py-6 md:p-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-normal sm:text-heading-5 text-tagline-1 mb-2">
                                    <a href="./blog-details-page.html" aria-label="Read more about brand storytelling">
                ...
                <article data-ns-animate data-delay="0.5" class="group">
                    ...
                    >
                        ...
                        >
                            <img
                                src="images/blogs/blog-12.png"
                                alt="AI trends concept illustration"
                                loading="lazy"
                                class="w-full h-full object-cover"
                            />
                        </figure>
                        <div class="px-4 py-6 md:p-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-normal sm:text-heading-5 text-tagline-1 mb-2">
                                    <a href="./blog-details-page.html" aria-label="Read more about AI trends">
                ...
                <article data-ns-animate data-delay="0.3" class="group">
                    ...
                    >
                        ...
                        >
                            <img
                                src="images/blogs/blog-13.png"
                                alt="Business resilience concept illustration"
                                loading="lazy"
                                class="w-full h-full object-cover"
                            />
                        </figure>
                        <div class="px-4 py-6 md:p-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-normal sm:text-heading-5 text-tagline-1 mb-2">
                                    <a href="./blog-details-page.html" aria-label="Read more about business resilience">
                ...
                <article data-ns-animate data-delay="0.4" class="group">
                    ...
                    >
                        ...
                        >
                            <img
                                src="images/blogs/blog-14.png"
                                alt="User-centered design concept illustration"
                                loading="lazy"
                                class="w-full h-full object-cover"
                            />
                        </figure>
                        <div class="px-4 py-6 md:p-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-normal sm:text-heading-5 text-tagline-1 mb-2">
                                    <a
                                        href="./blog-details-page.html"
                                        aria-label="Read more about user-centered design"
                                    >
                ...
                <article data-ns-animate data-delay="0.5" class="group">
                    ...
                    >
                        ...
                        >
                            <img
                                src="images/blogs/blog-15.png"
                                alt="Modern web development concept illustration"
                                loading="lazy"
                                class="w-full h-full object-cover"
                            />
                        </figure>
                        <div class="px-4 py-6 md:p-4 space-y-6">
                            ...
                            <div>
                                <h3 class="font-normal sm:text-heading-5 text-tagline-1 mb-2">
                                    <a
                                        href="./blog-details-page.html"
                                        aria-label="Read more about modern web development"
                                    >
          ...
          <span>
            ...
            >
              <path
                  ...
                  class="stroke-secondary dark:stroke-accent group-hover:stroke-white duration-300"
                  stroke-width="1.5"
