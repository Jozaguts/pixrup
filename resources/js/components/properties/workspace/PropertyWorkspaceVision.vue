    ...
    <div class="flex flex-col gap-6 text-[#1f2937]">
        ...
        <section class="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
            <article class="space-y-5 p-6 neu-surface shadow-neu-out">
                <div class="p-6 neu-surface shadow-neu-out">
                    ...
                    >
                        <button
                            type="button"
                            class="flex items-center gap-2 neu-btn px-5 py-3 text-sm font-semibold text-[#7c4dff] "
                        >
                ...
                <div class="grid gap-4 md:grid-cols-3">
                    <div class="px-4 py-5 text-sm text-gray-600 neu-surface shadow-neu-out">
            ...
            <aside class="flex flex-col gap-5 rounded-[28px] neu-surface shadow-neu-out p-6">
                ...
                <div class="p-4 text-sm text-gray-600 neu-surface shadow-neu-out">
                ...
                <div class="p-4 text-sm text-gray-600 neu-surface shadow-neu-out">
                    ...
                    <p class="text-sm text-gray-500">Password protected link — expires in 7 days.</p>
                    <button
                        type="button"
                        class="mt-3 inline-flex items-center gap-2 px-3 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-[#7c4dff]  neu-surface shadow-neu-in"
                    >
