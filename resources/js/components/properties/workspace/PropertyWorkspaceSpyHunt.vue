    ...
    <div class="flex flex-col gap-6 text-[#1f2937]">
        ...
        <section class="grid gap-6 lg:grid-cols-[1.4fr_1fr]">
            <article class="space-y-6 rounded-[28px]  p-6 ">
                <div class="neu-surface shadow-neu-out p-6">
                    ...
                    <div
                        class="mt-4 h-64 neu-surface shadow-neu-in"
                    />

                    <div class="mt-4 grid gap-3 sm:grid-cols-3">
                        <div class="rounded-[18px]  px-4 py-3 text-sm font-semibold text-[#1f2937] ">
            ...
            <aside class="flex flex-col gap-5 rounded-[28px]  p-6 ">
                <header class="flex items-center justify-between">
                    ...
                    <div class="neu-surface shadow-neu-out "><Target class="h-5 w-5 text-[#7c4dff]" /></div>
                </header>
                <p class="text-sm text-gray-500">
