...
<template>
    ...
    >
        ...
        <div v-else-if="hasComparables" class="overflow-hidden rounded-[22px]">
            <table
                class="min-w-full divide-y divide-[#e5e7eb] text-sm text-[#0d0d12]"
            >
                <thead
                    class="bg-[#f4f5fa] text-xs font-semibold tracking-[0.25em] text-[#6b7280] uppercase"
                >
                    <tr>
        ...
        >
            No comparables yet — fetch a valuation to populate nearby sale
            activity.
        </p>
    </section>
</template>
