...
<template>
    ...
    >
        ...
        <p class="rounded-[20px] bg-[#f4f5fa] px-4 py-3 text-sm text-[#6b7280] shadow-[inset_8px_8px_20px_rgba(210,212,226,0.55),inset_-8px_-8px_20px_rgba(255,255,255,0.95)]">
            {{ noteCopy }}
        </p>
    </section>
</template>
