            ...
            <div class="mb-[70px] space-y-5 text-center">
                ...
                <div class="space-y-3">
                    ...
                    <p data-ns-animate data-delay="0.4" class="mx-auto max-w-[700px]">
                        Pixrup helps you generate, transform, and deliver on-brand content in minutes—secure,
                        collaborative, and PWA-ready for any team.
                    </p>
                </div>
            </div>
            <p class="text-primary">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci, eveniet.</p>
