...
interface PropertyWorthRepositoryInterface
{
     ...
     * Returns: ?AppraisalSnapshot
     * Expected Result: Returns a domain entity if a fresh valuation exists, otherwise null.
     */
    public function findLatestWithin(int $propertyId, Carbon $threshold): ?AppraisalSnapshot;
     ...
     */
    public function saveFromDto(int $propertyId, PropertyWorthDTO $dto): AppraisalSnapshot;
}
